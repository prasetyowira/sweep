...
generate: bin/mga bin/entc ## Generate code
	go generate -x ./...
	mga generate kit endpoint ./internal/app/chat/messaging/...
	mga generate event handler --output subpkg:suffix=gen ./internal/app/chat/messaging/...
	mga generate event dispatcher --output subpkg:suffix=gen ./internal/app/chat/messaging/...
	entc generate ./internal/app/chat/messaging/messagingadapter/ent/schema
