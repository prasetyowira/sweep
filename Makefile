...
generate: bin/mga bin/entc ## Generate code
	go generate -x ./...
	mga generate kit endpoint ./internal/app/sweep/product/...
	mga generate event handler --output subpkg:suffix=gen ./internal/app/sweep/product/...
	mga generate event dispatcher --output subpkg:suffix=gen ./internal/app/sweep/product/...
	entc generate ./internal/app/sweep/product/productadapter/ent/schema
