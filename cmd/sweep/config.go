...
import (
	...
	"github.com/prasetyowira/sweep/internal/platform/opencensus"
	"github.com/prasetyowira/sweep/internal/platform/watermill"
)
...
func configure(v *viper.Viper, p *pflag.FlagSet) {
	// Viper settings
	v.AddConfigPath(".")
	v.AddConfigPath(fmt.Sprintf("$%/", strings.ToUpper(envPrefix)))
